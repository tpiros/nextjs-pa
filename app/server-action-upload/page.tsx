...
const ServerActionUpload = () => {
  return (
    <div className="m-2 space-y-4">
      ...
      <p className="m-2">
        This example shows how to upload images via <a className="underline text-blue-500 hover:bg-blue-200 rounded-full transition duration-300" href="https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations">Next.js Server Actions</a>.
      </p>
      <div className="m-2">
